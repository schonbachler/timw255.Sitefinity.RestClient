...
namespace timw255.Sitefinity.RestClient.ServiceWrappers.Ecommerce.Order
{
    public class PaymentMethodServiceWrapper : ServiceWrapper
    {
        ...
        {
            var request = new RestRequest(this.GetServiceUrl("/{paymentMethodId}/?provider={provider}&language={deletedLanguage}"), Method.DELETE);
        ...
        {
            var request = new RestRequest(this.GetServiceUrl("/{paymentMethodId}/?provider={provider}"), Method.GET);
        ...
        {
            var request = new RestRequest(this.GetServiceUrl("/{paymentMethodId}/?provider={provider}"), Method.PUT);
